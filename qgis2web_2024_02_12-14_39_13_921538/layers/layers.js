...
lyr_GoogleSatelliteHybrid_0.setVisible(true);lyr_amphoe_1.setVisible(true);lyr_village_2.setVisible(true);lyr_water_way_3.setVisible(true);
var layersList = [lyr_GoogleSatelliteHybrid_0,lyr_amphoe_1,lyr_village_2,lyr_water_way_3];
...
lyr_amphoe_1.set('fieldLabels', {'ID': 'no label', 'AMP_CODE': 'hidden field', 'AMP_TH': 'no label', 'AMP_EN': 'no label', 'PROV_CODE': 'no label', 'PROV_TH': 'no label', 'PROV_EN': 'header label - visible with data', 'REG_NESDB': 'header label - visible with data', 'REG_ROYIN': 'no label', 'AREA': 'no label', 'ADMIN_TYPE': 'no label', });
lyr_village_2.set('fieldLabels', {'NRD_CODE': 'no label', 'VILL_CODE': 'no label', 'VILL_NAM_T': 'no label', 'PROV_CODE': 'no label', });
lyr_water_way_3.set('fieldLabels', {'osm_id': 'no label', 'code': 'header label - always visible', 'fclass': 'hidden field', 'width': 'no label', 'name': 'no label', });
